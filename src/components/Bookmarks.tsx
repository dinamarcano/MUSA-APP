...
const Bookmarks: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'publicaciones' | 'guardados'>('guardados');
  ...
  const savedItems: SavedItem[] = [
    ...
    { 
      ...
      author: 'Lucía G.',
      image: 'https://i.pinimg.com/736x/95/5d/7b/955d7bc13fccbc8da479b178772a74f9.jpg',
      category: 'Diseño',
    ...
    { 
      ...
      author: 'Caro P.',
      image: 'https://i.pinimg.com/736x/99/27/5b/99275b999fa4411b1c05b6657ac887d1.jpg',
      category: 'Arte',
    ...
    { 
      ...
      author: 'David T.',
      image: 'https://i.pinimg.com/736x/32/85/ce/3285ce2e048ca689d8eb9384528cacb1.jpg',
      category: 'Fotografía',
    ...
    { 
      ...
      title: 'Animación 3D', 
      author: 'Sofía L.',
      image: 'https://i.pinimg.com/1200x/24/5b/6b/245b6b5e8e41fb5767f9d1528697755e.jpg',
      category: 'Animación',
  ...
  return (
    <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div className="flex-1">
            <div className="flex items-center space-x-4">
              <div>
                <h1 className="text-2xl font-bold text-gray-800">María Gonzalez</h1>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                <div className="text-2xl font-bold text-black-600">{savedItems.length}</div>
      ...
      {activeTab === 'publicaciones' && (
        <div className="text-center py-12">
          <div className="text-6xl mb-4">📝</div>
          <h3 className="text-xl font-semibold text-gray-700 mb-2">Tus publicaciones</h3>
          <p className="text-gray-500">Aquí aparecerán las publicaciones que crees.</p>
        </div>
      )}
    </div>
  );
