...
const RegisterPage = () => {
  ...
  const IconDocument = () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-gray-700">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-2.126c-.846 0-1.666.337-2.261.932l-.961.962c-.6.6-1.397.937-2.261.937H6.75A1.125 1.125 0 0 0 5.625 12V6a1.125 1.125 0 0 1 1.125-1.125h11.25c.621 0 1.125.504 1.125 1.125v12.75c0 .621-.504 1.125-1.125 1.125H6.75a1.125 1.125 0 0 1-1.125-1.125v-1.5" />
      </svg>
  );
       ...
       <div className="w-full max-w-full md:max-w-md bg-white rounded-none md:rounded-3xl p-0 md:p-8 md:shadow-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form className="flex flex-col gap-4 px-4 pb-8 md:pb-0">
            ...
            <div className="relative flex flex-col gap-1">
                ...
                <p className="text-xs text-gray-500 text-center pt-1">Usa ocho o mas letras, números y símbolos</p>
            </div>

            <div className="relative mt-4">
              <label className="text-gray-700 text-xs mb-2 block font-medium text-center">Fecha de nacimiento</label>
              <div className={`relative flex items-center ${inputBgColor} rounded-xl px-4 py-3`}>
                  <span className="absolute left-4 top-1/2 transform -translate-y-1/2">
                    <IconDocument />
                  </span>
